...
![](https://github.com/makuvex/makuvex.github.io/blob/main/assets/combine_publisher1.jpg?raw=true)
...
## 4. 예제로 시작하기
Publisher는 프로토콜 입니다. 아래 소스에서 사용된 Just는 이를 conform 한 단일 element를 방출 할수 있는 빌트인 Publisher이며 실패 타입은 Never 입니다.
